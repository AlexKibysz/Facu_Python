...
# Punto 2
    ...
    print('/' * 100)
    print('\n', nombre, 'Responda utilizando \033[1;32m(1 = Si / 2 = No)'
                        '\033[0m según corresponda\n')

    tos = int(input('-¿Padece de tos?: '))
    odinofagia = int(input('-¿Padece de dolor de garganta?: '))
    dif_respi = int(input('-¿Posee alguna otra dificultad respiratoria?: '))
...
# Punto 3
    ...
    if temperatura > 37 and problemas_respiratorios > 0:
        ...
        print('Sr/Sra.' + nombre, '\nresponda utilizando \033[1;32m(1 = Si / 2 = No)'
                                  '\033[0m segun corresponda\n')
        ...
        local = int(input('-¿Estuvo en zonas nacionales con casos '
                          'de transmisión local confirmados?: '))
        ...
        if caso_sospechoso and sospechoso_autoctono and not sospechoso_exterior\
                and problemas_respiratorios > 1:
            ...
            mensaje = '\033[1;31m--CASO SOSPECHOSO--\033[0;0m\n' \
                      'Se piensa que el contagio podria ser importado del extranjero.'
