...
# Cada registro representa una apuesta realizada para una
# cierta carrera, con los siguientes datos:
#
# /////
# número de ticket,
# caballo elegido (un número del 0 al 9, validar)
# y monto a apostar.
# //////
...
#Buscar un ticket cuyo número se ingresa por teclado. Si no existe,
# informarlo. Si existe, multiplicar por 10 el monto apostado y mostrar los datos de la apuesta.
