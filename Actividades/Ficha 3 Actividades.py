...
partidah, partidam = float(input('hora de partida')), float(input('minuto de partida'))
print('ingrese su hora y minuto de llegada')
llegadah, llegadam = float(input('hora de llegada')), float(input('minuto de llegada'))
...
tiempototalprueba= (tiempofinalhoras, 'hs', tiempofinalminutos, 'min', tiempototlasegundos, 's')
